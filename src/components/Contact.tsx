  ...
  const contactInfo = [
    {
      icon: Phone,
      title: 'Call Us',
      details: ['(405) 555-AUTO', '(405) 555-2886'],
      action: 'tel:+14055552886'
    },
    {
      icon: Mail,
      title: 'Email Us',
      details: ['sales@thunderauto.com', 'service@thunderauto.com'],
      action: 'mailto:sales@thunderauto.com'
    },
    {
      icon: MapPin,
      title: 'Visit Us',
      details: ['123 Thunder Avenue', 'Oklahoma City, OK 73102'],
          ...
          >
            ...
            >
              <div className="text-center text-gray-500">
                ...
                <p>Interactive Map</p>
                <p className="text-sm">123 Thunder Avenue, OKC</p>
              </div>
            </motion.div>
          </motion.div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full bg-primary-600 hover:bg-primary-700 text-white py-4 px-6 rounded-lg font-semibold text-lg transition-colors flex items-center justify-center space-x-2"
                >
